...
public class SingleChatActivity extends BaseActivity {
        ...
        mBt_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(text)) {
                    Message message = JMessageClient.createSingleTextMessage(username,
                            text);
    ...
    private MessageAdapter.MyClickListener mListener = new MessageAdapter.MyClickListener() {
        ...
        public void myOnClick(int p, View v) {
            ...
            if (u.equals(JMessageClient.getMyInfo().getUserName())) {
                i.setClass(SingleChatActivity.this, MyInfoActivity.class);
            } else {
                i.putExtra("u", u);
                i.setClass(SingleChatActivity.this, UserInfoActivity.class);
            }
    ...
    private void uploadPic(String picturePath) {
        if (picturePath != null) {
            ...
            try {
                final Message message = JMessageClient.createSingleImageMessage(username, file);
                message.setOnSendCompleteCallback(new BasicCallback() {
                    @Override
                    public void gotResult(int i, String s) {
                        if (i == 0) {
