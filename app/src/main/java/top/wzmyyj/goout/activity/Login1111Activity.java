...
public class Login1111Activity extends AppCompatActivity {
    //content
    ...
    private void initView() {
        setContentView(R.layout.activity_loginqqq);
        ...
        mBt_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(username)) {
                    Toast.makeText(Login1111Activity.this,
                ...
                mProgressDialog = ProgressDialog.show(Login1111Activity.this,
                        "提示：",
                        "加载中。。。。");
